...
namespace VT
{
    public class TableNode
    {
        ...
        public TableNode(int x, int y, int width, int height, int mip)
        {
    ...
    public class PageLevelTable
    {
        ...
        public PageLevelTable(int mip, int tableSize)
        {
            ...
            Cell                = new TableNode[NodeCellCount, NodeCellCount];
            for (int i = 0; i < NodeCellCount; i++)
            {
                for (int j = 0; j < NodeCellCount; j++)
                {
                    Cell[i, j]  = new TableNode(i * PerCellSize,j * PerCellSize,PerCellSize, PerCellSize, MipLevel);
                }
            }
        }
        ...
        public TableNode Get(int x, int y)
        {
            x                   /= PerCellSize;
            y                   /= PerCellSize;
        ...
        {
            return new RectInt( rect.xMin - pageOffset.x,rect.yMin - pageOffset.y,
