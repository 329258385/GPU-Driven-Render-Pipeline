...
public sealed unsafe class ClusterMeshInfo : ScriptableObject
{
    public static ClusterMeshInfo current { get; private set; }
    #region SERIALIZABLE
    ...
    public void Init(GPUDrivenRenderPipelineAsset res)
    {
        current = this;
    ...
    public void UpdateData(CommandBuffer buffer, GPUDrivenRenderPipelineAsset res)
    {
