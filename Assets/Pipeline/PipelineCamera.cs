...
public unsafe sealed class PipelineCamera : MonoBehaviour
{
    ...
    public GPUDrivenRenderPipelineAsset.CameraRenderingPath renderingPath = GPUDrivenRenderPipelineAsset.CameraRenderingPath.GPUDeferred;
    ...
    public void EnableThis(GPUDrivenRenderPipelineAsset res)
    {
    ...
    public void BeforeFrameRendering()
    {
        ...
        GpuFrustumCullingPipeline.GetFrustumCorner(ref perspCam, corners);
        ...
        GpuFrustumCullingPipeline.GetPerspFrustumPlanesWithCorner(ref perspCam, frustumArray.unsafePtr, corners + 4);
    }
