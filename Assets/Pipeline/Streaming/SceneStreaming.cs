...
public unsafe sealed class SceneStreaming : MonoBehaviour
{
    ...
    {
        //var resources       = ClusterMat.current;
        //allStrings[0]       = ClusterMat.infosPath;
    ...
    {
        //var clusterResources            = ClusterMat.current;
    ...
    private IEnumerator GenerateRun()
    {
        ...
        //{
        //    SetCustomData(baseBuffer.clusterBuffer, loader.cluster, currentCount,currentCount + clusterCount, MAXIMUMVERTCOUNT);
        ...
        //    yield return null;
        //}
        //SetCustomData(baseBuffer.clusterBuffer, loader.cluster, currentCount, currentCount + clusterCount, loader.clusterCount - currentCount);
        //SetCustomData(baseBuffer.verticesBuffer, loader.points, currentCount * PipelineBaseBuffer.CLUSTERCLIPCOUNT,
        //                (currentCount + clusterCount) * PipelineBaseBuffer.CLUSTERCLIPCOUNT,
        //                (loader.clusterCount - currentCount) * PipelineBaseBuffer.CLUSTERCLIPCOUNT);
        //SetCustomData(baseBuffer.triangleMaterialBuffer,loader.triangleMats, currentCount * PipelineBaseBuffer.CLUSTERTRIANGLECOUNT,
        //                (currentCount + clusterCount) * PipelineBaseBuffer.CLUSTERTRIANGLECOUNT,
